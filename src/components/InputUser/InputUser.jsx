...
const InputUser = () => {
  ...
  return (
    <>
      <section className="h-[100px] bg-transparent flex items-center lg:w-[80%]  justify-center pt-12 max-lg:w-full  max-lg:pr-2 ">
        <form onSubmit={handleSubmit(onSubmit)} className="flex">
          <section className="relative">
            <input
              type="text"
              placeholder="Filter by title, companies, expertise..."
              className="pl-14  h-16 bg-white  dark:bg-[#19202d]  dark:text-white   max-md:border-r-transparent lg:w-[350px] max-md:overflow-hidden text-ellipsis  max-lg:w-full outline-none max-sm:w-full py-3 font-semibold shadow-l-lg border-r-2 border-[#f1f1f1] dark:border-[#333c4b] rounded-l-md"
              {...register("info")}
            />
            <img
          ...
          <section className="relative">
            <section className="pl-10  select-none pr-3 h-16  dark:bg-[#19202d]  dark:text-white flex items-center gap-3 justify-between bg-white lg:w-[350px] max-lg:w-full  py-3  shadow-r-lg rounded-r-md">
              <section className="flex gap-3 items-center font-bold max-md:hidden">
                <div
